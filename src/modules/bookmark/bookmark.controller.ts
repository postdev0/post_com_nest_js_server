...
export class BookmarkController {
    ...
    async create(
        ...
        try {
            let result = await this.bookmarkService.addRemoveBookmark(dto, (request as any).user)
    ...
    async get(
        ...
        try {
            let { result, count } = await this.bookmarkService.getAllbookmarkedUsersOfTweet(tweetId, (request.user as any).id)
