...
export class LikeController {
    ...
    async create(
        ...
        try {
            let result = await this.likeService.addRemoveLike(dto, (request as any).user);
    ...
    async get(
        ...
        try {
            let { result, count } = await this.likeService.getAllLikedUsersOfTweet(tweetId, (request.user as any).id, page, pageSize);
