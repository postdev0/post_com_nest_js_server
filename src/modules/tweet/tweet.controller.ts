...
export class TweetController {
  ...
  async getAll(
    ...
    try {
      let { result, count } = await this.tweetsService.getAll(
  ...
  async getById(
    ...
    try {
      let result = await this.tweetsService.getById(
        id,
        (request as any).user?.id,
      );
      successResponse(response, result);
  ...
  async updateById(
    ...
    try {
      let result = await this.tweetsService.updateById(
        id,
        updateTweetDto,
        media,
      );
  ...
  async updateActionById(
    ...
    try {
      let result = await this.tweetsService.updateActionById(
        (request as any).user?.id,
        id,
        action,
      );
  ...
  async getTweetsByUserInterests(
    ...
    try {
      let result = await this.tweetsService.getTweetsByUserInterests(
  ...
  async getTweetsForHome(
    ...
    try {
      ...
      if (page * pageSize >= totalCount) {
        let { result: newResult, count } = await this.tweetsService.getAll(
          (request as any).user?.id,
          page,
          pageSize,
        );
  ...
  async getTweetsForHomeByFollowers(
    ...
    try {
      let { result, count } = await this.tweetsService.getTweetsOfFollowers(
        (request.user as any).id,
        page,
        pageSize,
      );
