...
export class FollowController {
  ...
  async followUnfollowUser(
    ...
    try {
      let result = await this.followService.followUnfollowUser(
  ...
  async getFollowers(
    ...
    try {
      let { result, count } = await this.followService.getFollowers(
  ...
  async getFollowings(
    ...
    try {
      let { result, count } = await this.followService.getFollowings(
        id || (request.user as any).id,
        (request.user as any).id,
        page,
        pageSize,
  ...
  async getSearchFollowers(
    ...
    try {
      let { result, count } = await this.followService.getSearchFollowers(
        searchQuery,
        id || (request.user as any).id,
        (request.user as any).id,
        page,
  ...
  async getSearchFollowings(
    ...
    try {
      let { result, count } = await this.followService.getSearchFollowings(
        searchQuery,
        id || (request.user as any).id,
        (request.user as any).id,
        page,
